...
class Reporter {
    ...
    getCurrentSuiteTempId () {
        const tempId = this.suitesStackTempInfo.length ?
            this.suitesStackTempInfo[this.suitesStackTempInfo.length - 1].tempId : null;
    ...
    onStart (err, o) {
        ...
        this.suitesStackTempInfo.push({ tempId: suiteObj.tempId, ref: o.cursor.ref });
    }
    ...
    onBeforeRequest (err, o) {
        ...
        const description = o.request.description && o.request.description.content;
        ...
        this.sendRequestLogs(testObj.tempId, o.request);
    ...
    finishTest (reference, testObj, run) {
        ...
        execution && execution.response && this.sendResponseLogs(testObj.testId, execution.response);
        this.client
            .finishTestItem(testObj.testId, {
